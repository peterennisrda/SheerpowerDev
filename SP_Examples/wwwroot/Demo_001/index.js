...
class Flower {
  ...
  create() {
    ...
    this.group = document.createElementNS('httpwww.w3.org2000svg', 'g');
    ...
    for (let i = rings; i  0; i--) {
      layer = document.createElementNS('httpwww.w3.org2000svg', 'g');
...
class Petal {
  ...
  create() {
    this.path = document.createElementNS('httpwww.w3.org2000svg', 'path');
